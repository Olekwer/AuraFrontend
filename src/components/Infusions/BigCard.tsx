export const bigCards = [
  {
    iconClassName:
      'w-12 h-12 rounded-full bg-gradient-to-r from-blue-500 to-cyan-500 flex items-center justify-center mb-4 mx-auto',
  ...
  {
    iconClassName:
      'w-12 h-12 rounded-full bg-gradient-to-r from-red-500 to-orange-500 flex items-center justify-center mb-4 mx-auto',
  ...
  {
    iconClassName:
      'w-12 h-12 rounded-full bg-gradient-to-r from-green-500 to-brown-500 flex items-center justify-center mb-4 mx-auto',
        ...
        <div className="text-left">
          ...
          <div className="flex flex-wrap gap-1">
            {ingredients.map((ingredient, idx) => (
              <span
                key={idx}
                className="focus-visible:border-ring focus-visible:ring-ring/50 aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive inline-flex w-fit shrink-0 items-center justify-center gap-1 overflow-hidden whitespace-nowrap rounded-md border border-blue-500/30 bg-blue-500/20 px-2 py-0.5 text-xs font-medium text-blue-300 transition-[color,box-shadow] focus-visible:ring-[3px] [&>svg]:pointer-events-none [&>svg]:size-3"
              >
                {ingredient}
              </span>
            ))}
